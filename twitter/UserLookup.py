...
# up to 100 allowed in a single requests
...
if __name__ == "__main__":
    ...
    user_desc = []
    json_str = ""
    var_dict = get_followers(file_directory)
    for i in range(0, len(var_dict)):
        try:
            ...
            print('string{} of followers processed! {} requests remaining...'.format(i, len(var_dict)-i-1))
    ...
    df.to_json("{}_followers_info.json".format(os.path.basename(file_directory)), orient = "split", compression= "infer")
    print(df) #133,637 users information retrieved (instead of 133,725...)

### this part is weird, as number of requests made was 1338 times, we should get 133,724 user info, instead of 133,637
### WIP: investigating on the data loss

### load json file to check
# with open('380_followers_info.json') as json_file:
#     data2 = json.load(json_file)
# type(data2)
# data2.keys()
# len(data2["data"]) #133637